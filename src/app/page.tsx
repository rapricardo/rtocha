...
export default function Home() {
  return (
    <main className="min-h-screen font-[family-name:var(--font-convergence)]">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-sm shadow-sm">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex gap-8">
            ...
            <a href="#contato" className="font-medium text-gray-700 hover:text-[#d32b36]">Contato</a>
          </nav>
          <div className="hidden md:block">
            <Button href="#contato" size="sm" variant="primary">Fale Comigo</Button>
          </div>
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button href="#servicos" size="lg">Conheça os Serviços</Button>
              <Button href="#contato" variant="outline" size="lg">Entre em Contato</Button>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-[#d32b36] to-[#eea04a] rounded-2xl p-6 text-white flex flex-col justify-center shadow-md">
              ...
              <Button href="#contato" variant="accent" className="self-start">
                Vamos conversar
              </Button>
            </div>
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-[#d32b36] text-white">
      ...
      <section id="contato" className="py-20">
        <div className="container mx-auto px-4">
          <SectionTitle 
            ...
            subtitle="Vamos discutir como posso ajudar você a automatizar seus processos"
            centered
          />
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  Estou disponível para discutir seus desafios e como posso ajudar.
                </p>
                <div className="flex items-center mb-3">
                  <svg className="w-5 h-5 mr-3 text-[#d32b36]" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="flex items-center">
                  ...
                  <span>contato@ricardotocha.com.br</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-4">
                  <a href="https://linkedin.com/in/ricardotocha" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#d32b36]">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                    </svg>
                  </a>
                  <a href="https://twitter.com/ricardotocha" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#d32b36]">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723 10.054 10.054 0 01-3.127 1.184 4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/>
                    </svg>
                  </a>
                  <a href="https://instagram.com/ricardotocha" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-[#d32b36]">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <form className="bg-white rounded-2xl shadow-lg p-6">
              <div className="mb-4">
                ...
                <input 
                  ...
                  id="name" 
                  name="name" 
                  className="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#d32b36]"
                  required
                />
              </div>
              <div className="mb-4">
